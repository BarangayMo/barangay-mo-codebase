            ...
            <SheetContent side="left" className="w-80 p-0">
              <div className="p-4 space-y-6 overflow-y-auto h-full">
                ...
                {isAuthenticated ? (
                  ...
                  <div className="bg-gray-50 border-gray-200 p-4 rounded-lg border">
                    <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="space-y-2">
                    {(() => {
                      if (isAuthenticated) {
                        ...
                        return [
                          { name: "Home", icon: Home, href: "/", active: location.pathname === "/" },
                          { name: "Marketplace", icon: Store, href: "/marketplace" },
                          { name: "Services", icon: LifeBuoy, href: "/services" },
                      ...
                      >
                        <item.icon className={`h-5 w-5 ${
                          item.active ? 'text-blue-600' : 'text-blue-500'
                        }`} />
                ...
                <div className="border-t pt-4">
                  {isAuthenticated ? (
                    ...
                    <div className="space-y-2">
                      <Link 
                        to="/login" 
                        className="flex items-center gap-3 px-3 py-3 rounded-lg hover:bg-blue-50 cursor-pointer text-blue-600 w-full"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                      ...
                      <Link 
                        to="/register" 
                        className="flex items-center gap-3 px-3 py-3 rounded-lg hover:bg-green-50 cursor-pointer text-green-600 w-full"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        <User className="h-5 w-5" />
