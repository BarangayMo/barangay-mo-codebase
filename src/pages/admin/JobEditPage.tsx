...
export default function JobEditPage() {
          ...
          if (data.assigned_to) {
            ...
            if (profileData) {
              setAssignedUser({
                ...
                avatar_url: (profileData as any).avatar_url || `https://ui-avatars.com/api/?name=${profileData.first_name} ${profileData.last_name}&background=random`,
  ...
  // Auto-save as draft functionality (editing only)
  useEffect(() => {
    if (!isEditing) return;
