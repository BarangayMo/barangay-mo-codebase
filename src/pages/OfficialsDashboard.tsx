            ...
            <Card className="mt-6 bg-white shadow-sm border border-gray-100">
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link to="/official/officials" className="text-red-500 text-sm font-medium">View All</Link>
                </div>
                ...
                {barangayOfficials && barangayOfficials.length > 0 && (
                  <div className="mb-8">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <Link to="/official/officials" className="text-red-500 text-sm font-medium hover:underline flex-shrink-0">View All</Link>
                    </div>
