    ...
    const initMaps = async () => {
      try {
        ...
        if (typeof window.google !== "undefined" && typeof window.google.maps !== "undefined") {
          ...
          console.error("❌ ResidentJobsPage: Google Maps API not globally available after loadGoogleMaps resolved.")
          setIsMapsReady(false)
        }
      } catch (err) {
        console.error("❌ ResidentJobsPage: Google Maps failed to load:", err)
        setIsMapsReady(false)
      }
    }
    initMaps()
      ...
      <Layout>
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center gap-4 mb-6">
            <Button variant="ghost" onClick={() => navigate("/resident-home")} className="flex items-center gap-2">
