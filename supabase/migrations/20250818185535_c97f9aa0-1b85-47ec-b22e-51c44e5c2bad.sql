-- MPIN verification function and supporting columns
...
BEGIN
  ...
  -- Verify MPIN using pgcrypto's crypt
  IF crypt(p_mpin, v_profile.mpin_hash) = v_profile.mpin_hash THEN
...
-- 3) Grant execution to standard roles
